...
export function Sidebar({ onCreatePlaylist }: SidebarProps) {
  ...
  // Tentukan apakah lebar cukup untuk layout 4 baris (>= 300px)
  ...
  return (
    <div className="flex">
      ...
      >
        <div className="h-full flex flex-col gap-2 p-2">
          <div className="bg-[#121212] rounded-lg flex-1 flex flex-col overflow-hidden h-full">
            {/* Header Your Library dan tombol + */}
            <div className="flex items-center justify-between px-4 py-3 flex-shrink-0">
              <span className="font-bold text-[#b3b3b3] hover:text-white transition-colors cursor-pointer">
                Your Library
              </span>
              <button
            ...
            {/* Area scrollable untuk konten tengah (cards & footer) */}
            <div className="flex-1 overflow-y-auto px-2 pb-2 custom-scroll">
              ...
              {/* Footer - Responsif terhadap lebar */}
              <div className="flex flex-col gap-2 px-2 text-[11px] mb-6">
                {isWide ? (
                  // Layout lebar (>=300px): 4 baris
                  <>
                  ...
                  // Layout sempit (<300px): 3 baris (merge baris1+2 menjadi satu)
                  <>
                    <div className="flex flex-wrap gap-x-3">
                      <span className="cursor-pointer text-[#b3b3b3] hover:no-underline">Legal</span>
                      <span className="cursor-pointer text-[#b3b3b3] hover:no-underline">Safety & Privacy Center</span>
              ...
              {/* Tombol English - border only, hover scale */}
      ...
      {/* Drag handle (garis hitam untuk resize) */}
      <div
